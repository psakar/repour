...
#	declare -a REDHAT_TAGS=("1.3.14.Final-redhat-1" "1.3.16.Final-redhat-1" "1.3.17.Final-redhat-1" "1.3.18.Final-redhat-1")
	declare -a REDHAT_TAGS=("1.3.14.Final" "1.3.16.Final" "1.3.17" "1.3.18.Final")
	for REDHAT_TAG in "${REDHAT_TAGS[@]}"
	do
		git -C $INTERNAL_REPO checkout $TAG-redhat-1
		cp $INTERNAL_REPO/pom.xml $REPOUR_REPO/pom.xml #simulate change
		apply_prod_change_to_repour_repo $UPSTREAM_REPO_URL $REDHAT_TAG
	done
}
